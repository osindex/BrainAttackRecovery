...
### 需求： 宿主数据服务通过 DAO 与 ORM 契约执行数据库操作
...
### 需求： 宿主在 DoCommit 层统一拦截数据服务执行与事务提交
...
### 需求： 动态插件通过受限 ORM 风格 SDK 访问 data service
...
### 需求： data service 相关枚举语义值使用独立类型和常量统一管理
